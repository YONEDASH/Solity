...
import de.yonedash.solity.entity.EntityAnt;
import de.yonedash.solity.entity.EntityPlayer;
...
import static de.yonedash.solity.Direction.*;
...
public class TextureAtlas {
    ...
    // ING
    public Texture shuriken, coin, potionGreen, potionRed, potionYellow, animSlash, animAfterDeath, animHit;
    ...
    public void load() {
        ...
        this.shuriken = loadTexture("/assets/entities/projectile/Shuriken.png");
        ...
        // Load projectiles
        this.projCanonBall = loadTexture("/assets/entities/projectile/CanonBall.png", 5.0, 0, 0, 16, 16, EAST, 5);

        // Load player assets
        TextureBundle playerBundle = getBundleOrCreate(EntityPlayer.class);

        Texture ninjaWalk = loadTexture("/assets/entities/knight/Walk.png");
        ...
        Texture ninjaIdle = loadTexture("/assets/entities/knight/Idle.png");
        ...
        Texture antIdle = loadTexture("/assets/entities/ant/SoldierAntIdleSide.png", 4.0, 0, 0, 16, 16, EAST, 4);
        ...
        // Load effects
        this.animSlash = loadTexture("/assets/particles/slash_effect_anim_spritesheet.png",
                10.0, 0, 0, 16, 16, EAST, 3);

        this.animAfterDeath = loadTexture("/assets/particles/enemy_afterdead_explosion_anim_spritesheet.png",
                10.0, 0, 0, 16, 16, EAST, 4);

        this.animHit = loadTexture("/assets/particles/hit_effect_anim_spritesheet.png",
                10.0, 0, 0, 8, 8, EAST, 3);
